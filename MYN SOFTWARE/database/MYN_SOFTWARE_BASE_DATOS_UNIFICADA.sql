...
(Registra entradas, salidas, ajustes, compras, ventas y anulaciones)
============================================================*/
...
CREATE TABLE movimientos_inventario (
    ...
    referencia_id INT,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT fk_mov_inv_producto FOREIGN KEY(id_producto) REFERENCES productos(id),
    CONSTRAINT fk_mov_inv_usuario FOREIGN KEY(id_usuario) REFERENCES usuarios(id)
) ENGINE=InnoDB;
...
CREATE INDEX idx_mov_inv_producto ON movimientos_inventario(id_producto);
...
/* Para crear el administrador con contraseña bcrypt, ejecutar una vez:
   cd backend
